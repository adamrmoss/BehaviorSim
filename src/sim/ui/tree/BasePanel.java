...
/**
 * Main class that handles the display of the tree and displays the correct
...
public abstract class BasePanel extends JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1607699818618060906L;
	...
	protected BorderTitlePanel navigatorPanel;
	...
	public BasePanel() {
		...
		buildTree();
		if (tree == null) {
			MessageUtils.displayError("The tree control should be setted up.");
			return;
		}
		...
		navigatorPanel.setCenterComponent(scrollPane);
		...
		tree.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				if (e.isPopupTrigger()) {
					showPopupForNode(e.getX(), e.getY());
				}
			}
	 ...
	 */
	private void showPopupForNode(int x, int y) {
