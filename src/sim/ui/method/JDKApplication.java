...
public abstract class JDKApplication {
	...
	public synchronized void setExitProcessMessage(
	...
	public synchronized void stopProcessing() {
		...
		// if (!flag) {
		// EJE.getEJE().appendText(
		// EJE.resources.getString("stream.no_process_to_interrupt"));
		// return;
		// }
		processes.removeAllElements();
		// EJE.getEJE().appendText(
		// EJE.resources.getString("stream.process_interrupted"));
