...
public class ObjectInterface extends JavaInterface {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -562116965654635666L;
	private static int rowLength = 0;

	/**
	 * Try to find a class with the name className in the class path and fill
	...
	public ObjectInterface(String className) throws ClassNotFoundException {
		...
		Class objectClass = Class
				.forName(className, false, new java.net.URLClassLoader(EJEArea
