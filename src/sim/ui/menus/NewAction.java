...
class NewAction extends AbstractAction {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3892106354116709336L;
	/**
	 * The main window
	 */
	...
	/**
	 * Creates the NewAction.
	 * 
	 */
	NewAction(MainFrame parent, MainApplet main) {
		super("New", GUIUtils.getImageIconForObject(GUIUtils.MENU_NEW_IMAGE));
		this.parent = parent;
		this.main = main;
