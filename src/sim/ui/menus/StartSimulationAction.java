...
class StartSimulationAction extends AbstractAction {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8416162601004426092L;
	/**
	 * The main window
	 */
	 ...
	 * Creates the action.
	 */
	StartSimulationAction(MainApplet main) {
		super("Start Simulation", GUIUtils
				.getImageIconForObject(GUIUtils.MENU_SIMULATION_IMAGE));
		this.main = main;
		super.putValue(Action.SHORT_DESCRIPTION,
				"Start simulation to see results");
	}
